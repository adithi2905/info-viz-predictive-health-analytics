...
This project was completed as part of the ENGR-E 483/583 course under the guidance of Dr. Andreas Bueckle. The project datasets and problem context were provided through the course by project sponsors Tank, Venkata Gopi Kolla, and Karnati. Additional environmental and healthcare access datasets were sourced from Kaggle. All analysis was conducted for educational and exploratory purposes using synthetic or mocked data where applicable.
